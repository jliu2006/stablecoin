...
busd_price = yf.download('BUSD-USD', start=start_date, end=end_date)['Close'].squeeze()
gyen_price = yf.download('GYEN-USD', start=start_date, end=end_date)['Close'].squeeze()
eurc_price = yf.download('EURC-USD', start=start_date, end=end_date)['Close'].squeeze()

# ---------------------------- Step 3: Simulate USDT transaction fee ----------------------------
...
# ---------------------------- Step 10: Instrument Strength Plot ----------------------------
f_stats = []
labels = []
