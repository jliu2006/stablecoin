...
f_stats = [
    sm.OLS(y_first, sm.add_constant(data[['USDT_CAD_price']])).fit().f_test("USDT_CAD_price = 0").statistic[0][0],
    sm.OLS(y_first, sm.add_constant(data[['USDT_fee']])).fit().f_test("USDT_fee = 0").statistic[0][0],
    sm.OLS(y_first, sm.add_constant(data[['DAI_Price']])).fit().f_test("DAI_Price = 0").statistic[0][0]
]
