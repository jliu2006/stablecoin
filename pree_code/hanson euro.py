...
# Forward-fill EUROE_Price & clean data
euroe_price_ff = euroe_price.reindex(data.index).fillna(method='ffill')
data['EUROE_Price'] = euroe_price_ff
...
# ---------------------------- Step 7: Instrument Strength Plot ----------------------------
f_stats = [
...
labels = ['USDT_CAD', 'USDT_fee', 'EUROE_Price']
